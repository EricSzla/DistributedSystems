public class BankMain {
	...
	public static void main(String args[]) {
		...
		// call a method
		int x = b1.getBalance();
        String depositAmmountString = args[0];
        String withdrawAmmountString = args[1];
        int depositAmmount = Integer.parseInt(depositAmmountString);
        int withdrawAmmount = Integer.parseInt(withdrawAmmountString);
        
		// print out
		System.out.println("The balance in b1 (Credit Account) is " + x);
        System.out.println("Deposit: " + depositAmmount);
        b1.deposit(depositAmmount);
        System.out.println("Balance is: " + b1.getBalance());
        System.out.println("Withdrawing : " + withdrawAmmount);
